...
<head>
  ...
  <title>Dashboard - MBTI-MATES</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets2/img/mbti-mates-logo.png" rel="icon">
  <link href="assets2/img/mbti-mates-logo.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="assets2/img/mbti-mates-logo.png" alt="">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav2" data-bs-toggle="collapse" href="#">
          ...
          <i class="bi bi-chevron-down ms-auto" data-bs-toggle="tooltip" data-bs-placement="right" title="Anda bisa melihat tabel seputar tipe kepribadian disini"></i>
          {{-- <button type="button" class="btn btn-default" data-bs-toggle="tooltip" data-bs-placement="right" title="Tooltip on right">
          </button> --}}
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav3" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journals"></i><span data-bs-toggle="tooltip" data-bs-placement="right" title="Anda bisa mulai test di halaman ini">Mulai Test</span>
          <i class="bi bi-chevron-down ms-auto" data-bs-toggle="tooltip" data-bs-placement="right" title="Anda bisa mulai test di halaman ini"></i>
          {{-- <button type="button" class="btn btn-default" data-bs-toggle="tooltip" data-bs-placement="right" title="Tooltip on right">
          </button> --}}
        </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>MBTI-MATES</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
