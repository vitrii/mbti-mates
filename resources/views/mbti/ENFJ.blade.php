...
<head>
    ...
    <head>
        @include('layouts.head', ['title' => 'Hasil Test'])
        <style>
            @media print {
                @page {
                    margin-top: 0;
...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="text-indigo-900"><b>Profesi yang cocok</b> :  Konsultan, Psikolog, Pengajar, Marketing, Entertainer, Penulis, Motivator</p>
        ...
        <div class="text-right text-indigo-900 mt-10">
            <p class="pb-16">Bandung, {{ now()->format('d M Y') }}</p>
            <p></p>
            <p></p>
        </div>
